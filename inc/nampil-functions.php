 ...
 */
if (!function_exists('nampil_understrap_posted_on')) {
    function nampil_understrap_posted_on()
    {
 ...
 */
if (!function_exists('nampil_understrap_entry_footer')) {
    function nampil_understrap_entry_footer()
    {
 ...
 * @return bool
 */
if (!function_exists('nampil_understrap_categorized_blog')) {
    function nampil_understrap_categorized_blog()
    {
